...
func TestParseCommand(t *testing.T) {
	tests := []struct {
		...
		{"reply", "/reply", "herdr_bot", domain.Command{Kind: domain.CmdReply}},
		{"reply upper case with suffix", "/REPLY@herdr_bot", "herdr_bot", domain.Command{Kind: domain.CmdReply}},
		{"reply with arg", "/reply now", "herdr_bot", domain.Command{Kind: domain.CmdUnknown, Text: "/reply now"}},
