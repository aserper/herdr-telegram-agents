...
func TestRegisterCommands(t *testing.T) {
	...
	f := calls[0].form
	cmds := f.Get("commands")
	for _, name := range []string{`"command":"screen"`, `"command":"reply"`, `"command":"keys"`, `"command":"focus"`, `"command":"git"`, `"command":"stop"`, `"command":"interrupt"`, `"command":"clear"`, `"command":"compact"`, `"command":"usage"`, `"command":"model"`, `"command":"close"`, `"command":"new"`, `"command":"observers"`, `"command":"status"`, `"command":"away"`, `"command":"here"`, `"command":"options"`, `"command":"help"`} {
